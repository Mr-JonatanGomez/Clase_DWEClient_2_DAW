...
export class ImagenesPipe implements PipeTransform {
  ...
  transform(value: string[], ...args: unknown[]): unknown {
    ...
    }else if (value[0].includes('french')) {
    ...
    }else if (value[0].includes('english')) {
    ...
    }else if (value[0].includes('crime')) {
    ...
    }else if(value[0].includes('american')){
